## Version 3.0.0
- Added an experimental feature to make weather effects visible on the camera regardless of distance from the local player. It is disabled by default for the moment. May cause custom weathers to behave unexpectedly.
