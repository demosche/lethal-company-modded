...
- No functional changes. This update sets the targetted [BarchLib](https://thunderstore.io/c/lethal-company/p/qwbarch/BarchLib/) version to ``1.0.2``.

### 1.7.2

- Added a config option to set the maximum number of naturally spawned masked enemies. By default, this is set to 2.
  Masked enemy spawns have already been capped at 2 since ``v1.6.1``, this update simply allows you to adjust that value.
